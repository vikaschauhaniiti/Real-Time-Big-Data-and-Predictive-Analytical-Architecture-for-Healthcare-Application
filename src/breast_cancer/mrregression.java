...
public class mrregression {
	 
	public static	OnlineLogisticRegression olr = new OnlineLogisticRegression(2, 30, new L2(1));
	...
	public void map(LongWritable key, Text value, OutputCollector<IntWritable, VectorWritable> output, Reporter reporter)
		...
		if(vl[1].equals("M")){
         ...
         eval.add(p,olr.classifyScalar(vec));
			...
			mrregression obj = new mrregression();
			...
			public void makemodel() throws IOException{
				String a="/home/raghav/mahout-model/logistical_regression/data.csv";
				String b="/home/raghav/myMTPproject/heart/out/bc";
				JobConf conf = new JobConf(mrregression.class);
				...
				ModelSerializer.writeBinary("/home/raghav/mahout-model/logistical_regression/mybc.model", olr);;
					
			}
			
			public void testmodel(double[] dw) throws FileNotFoundException, IOException{
				OnlineLogisticRegression classifier =
				ModelSerializer.readBinary(new FileInputStream("/home/raghav/mahout-model/logistical_regression/mybc.model"), OnlineLogisticRegression.class);
